...
INSERT INTO `account` VALUES (1,'hient14','$2a$10$S9OThrY32b8HJiUlJXClPeFVGdhW0uUv7yA62XAHwp3hmRClrY5Nq','ROLE_ADMIN',1),(2,'phuch','$2a$10$S9OThrY32b8HJiUlJXClPeFVGdhW0uUv7yA62XAHwp3hmRClrY5Nq','ROLE_ADMIN',1),(3,'vana1','$2a$10$S9OThrY32b8HJiUlJXClPeFVGdhW0uUv7yA62XAHwp3hmRClrY5Nq','ROLE_SELLER',1),(4,'vanb2','$2a$10$tRB5iaVnXzNFRS.D77Yjn.3csa4tIHncKjwVgNM/gA0YBdW/nMn/2','ROLE_SELLER',1),(5,'thia1','$2a$10$S9OThrY32b8HJiUlJXClPeFVGdhW0uUv7yA62XAHwp3hmRClrY5Nq','ROLE_CUSTOMER',1),(15,'nguoiban','$2a$10$ZHQ7onmvZw/ZhrUMz3ClO.3bpWvpMibG7dBr5OIMeLBkaMJHEfniK','ROLE_SELLER',1);
...
INSERT INTO `admin` VALUES (1,'Hiền','hien12@gmail.com','2548562','Nữ',1),(2,'Phúc','phuc2@gmail.com','05154154','Nam',2);
...
INSERT INTO `category` VALUES (1,'Thời trang','',0),(2,'Đời sống','',0),(3,'Điện tử','',0),(4,'Tiêu dùng','',0),(5,'Sức khỏe','',0),(6,'Sắc đẹp','',0),(7,'Thể thao','',0),(50,'Y tế','Thiết bị hỗ trợ',0);
...
INSERT INTO `customer` VALUES (1,'Thị A','Trần','thia11@gmail.com','014587522','https://res.cloudinary.com/dxs9d8uua/image/upload/v1666303672/mn3khwmvj1xxfx3kku5e.jpg','2022-01-25 00:00:00','Nữ',1,5,'');
...
INSERT INTO `order_detail` VALUES (1,32000000,1,0.1,1,1),(2,32000000,3,0.1,2,1),(3,145000,2,0.1,4,1),(4,32000000,1,0.1,2,3);
...
INSERT INTO `orders` VALUES (1,1,'2022-05-05 00:00:00','2022-05-15 00:00:00',57600000,0,0,1,1,2),(3,1,'2022-05-06 00:00:00','2022-05-16 00:00:00',28800000,0,1,1,1,NULL);
...
INSERT INTO `product` VALUES (1,'Iphone 13 promax xanh',' màu xanh dương',32000000,'Apple','2022-09-10 00:00:00',1,10,3,1,0),(2,'Iphone 13 promax trắng',' màu trắng',32000000,'Apple','2022-09-12 00:00:00',1,10,3,1,0),(3,'Asus X552CL-SX019D','Laptop',26600000,'Asus','2022-09-12 00:00:44',1,10,3,1,0),(4,'Áo thun trắng trơn','Màu trắng ',145000,'Nobrand','2022-09-14 00:00:44',1,10,1,1,0),(16,'Áo thun vàng trơn','Màu vàng',145000,'Nobrand','2022-10-20 18:28:18',1,12,1,1,0),(20,'Áo thun đen','Áo thun đen',145000,'NoBrand','2022-10-20 18:27:03',1,30,1,1,0),(21,'Áo thun sọc','sadasd',145000,'NoBrand','2022-09-30 01:27:24',1,12,1,2,0),(41,'testsp','rfgthszdfgvb',52000,'ưedfg','2022-10-20 18:29:27',1,1,1,1,1);
...
INSERT INTO `review` VALUES (35,2,'Hài lòng','2022-10-04 04:47:44',5,1),(36,1,'thất vọng','2022-10-04 04:47:55',5,1),(38,2,'Woww','2022-10-07 17:54:10',5,1),(40,2,'Tuyệt','2022-10-07 18:21:51',5,1);
...
INSERT INTO `seller` VALUES (1,'Văn A','vana11@gmail.com','015895623','https://res.cloudinary.com/dxs9d8uua/image/upload/v1666303139/yocdye8cyehhfx3zdzkf.png',3,1,'10/2 Au Duong Lan','Văn a luôn hỗ trợ'),(2,'Văn B','vanb1@gmail.com','0215852','https://res.cloudinary.com/dxs9d8uua/image/upload/v1664388454/h2vgimqooh1i3e0pbjb4.jpg',4,5,'72 Hàn Hải',''),(4,'nguoiban','ngb234@gmail.com','0124578542','https://res.cloudinary.com/dxs9d8uua/image/upload/v1664388454/h2vgimqooh1i3e0pbjb4.jpg',15,2,'67 nguyen hai','');
...
CREATE TABLE `seller_order` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_so_seller_idx` (`idSeller`),
  KEY `fk_so_order_idx` (`idOrder`),
  CONSTRAINT `fk_so_order` FOREIGN KEY (`idOrder`) REFERENCES `orders` (`id`),
  CONSTRAINT `fk_so_seller` FOREIGN KEY (`idSeller`) REFERENCES `seller` (`id`)
...
INSERT INTO `seller_order` VALUES (1,1,1),(2,1,3);
...
INSERT INTO `voucher` VALUES (1,'voucher thân thiết',0.1,10,'2022-05-09 00:00:00','2022-05-30 00:00:00','XINCHAO10',NULL,0,1),(2,'voucher mới',0.2,5,'2022-05-09 00:00:00','2022-05-30 00:00:00','XINCHAO20',NULL,0,1);
...
INSERT INTO `voucher_customer` VALUES (4,2,1);
...
-- Dump completed on 2022-10-22 19:11:50
