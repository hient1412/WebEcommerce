                        ...
                        <li class="dropdown nav-item active">
                            ...
                            <c:if test="${pageContext.session.getAttribute('current').role == ('ROLE_CUSTOMER')}">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="<c:url value="/customer/list-cus-order"/>"><i class="fas fa-file"></i>  <spring:message code="label.order"/></a></li>
                                    <li><a href="<c:url value="/customer/liked"/>"><i class="fas fa-heart"></i> <spring:message code="label.liked"/></a></li></a></li>
