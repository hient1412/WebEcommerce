            ...
            <form:form action="" method="post" modelAttribute="product" enctype="multipart/form-data">
                <div class="form-group row">
                    ...
                    <div class="col">
                        ...
                        <form:input type="text" pattern="\d*" path="price" required="required" class="form-control" maxlength="10" autocomplete="off"/>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-6 col-lg-4">
                        ...
                        <form:input type="text" path="manufacturer" required="required" class="form-control" autocomplete="off"/>
                    </div>
