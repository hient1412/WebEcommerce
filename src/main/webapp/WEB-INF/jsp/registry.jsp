        ...
        <form:form method="post" action="${action}" modelAttribute="account">
            ...
            <div class="m-3">
                <div class="form-group">
                    ...
                    <form:input type="text" autocomplete="off" class="form-control" id="inputUsername" path="username"/>
                </div>
                <div class="form-group">
                    <label for="inputPassword">Mật khẩu</label>
                    <form:input autocomplete="off" type="password" class="form-control" id="inputPassword" path="password"/>
                </div>
                <div class="form-group">
                    <label for="confirmPassword">Xác nhận mật khẩu</label>
                    <form:input autocomplete="off" type="password" class="form-control" id="confirmPassword" path="confirmPassword"/>
                </div>
